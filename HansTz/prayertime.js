...
async(conn, mek, m, {from, l, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, isItzcp, groupAdmins, isBotAdmins, isAdmins, reply}) => {
    try {
        ...
        await conn.sendMessage(
            from,
            {
                image: { url: `https://raw.githubusercontent.com/Mrhanstz/HansTz-Sever/refs/heads/main/Database/HansTz7.jpg` }, // Image URL here
                caption: dec,
                contextInfo: {
        ...
        await conn.sendMessage(from, {
            audio: { url: 'https://raw.githubusercontent.com/Mrhanstz/HansTz-Sever/refs/heads/main/Database/HansTz7.jpg' },
            mimetype: 'audio/mp4',
            ptt: false
        }, { quoted: mek });
